...
import { NotificationConsumer, ActivityFeedConsumer, AnalyticsConsumer, AuditLogConsumer, SearchIndexConsumer } from '../consumers';
import {
  TaskCreatedEvent,
  TaskAssignedEvent,
  TaskCompletedEvent,
    ...
    <div class="demo-container">
      ...
      <section class="search">
        ...
        <div class="search-box">
          <input #searchInput type="text" placeholder="Search..." (input)="performSearch(searchInput.value)" />
        </div>
