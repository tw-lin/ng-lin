...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'profile',
        loadComponent: () => import('../profile/components/account-profile-page.component').then(m => m.AccountProfilePageComponent),
      ...
      {
        path: 'dashboard',
        loadComponent: () => import('../dashboard/components/account-dashboard-page.component').then(m => m.AccountDashboardPageComponent),
      ...
      {
        path: 'settings',
        loadComponent: () => import('../settings/components/account-settings-page.component').then(m => m.AccountSettingsPageComponent),
