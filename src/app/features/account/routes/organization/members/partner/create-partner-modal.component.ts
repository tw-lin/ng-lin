/**
 * Create Partner Modal Component - Modern Angular 20 Implementation
 *
 * 建立夥伴模態元件 - 現代化 Angular 20 實作
 *
...
import { PartnerStore, PartnerType } from '@core';
...
export class CreatePartnerModalComponent {
  ...
  async submit(): Promise<void> {
    ...
    try {
      ...
      const partner = await this.partnerStore.createPartner({
        organization_id: this.modalData.organizationId,
      ...
      this.message.error('建立夥伴失敗，請稍後再試');
    } finally {
